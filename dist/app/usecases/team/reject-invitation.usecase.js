...
exports.RejectInvitationUseCase = void 0;
...
class RejectInvitationUseCase {
    ...
    async execute(dto) {
        if (!dto.deposit_id || !dto.user_id) {
            throw new BadRequestError_1.BadRequestError("No se proporcionó el depósito o el usuario para rechazar la invitación");
        }
...
exports.RejectInvitationUseCase = RejectInvitationUseCase;
